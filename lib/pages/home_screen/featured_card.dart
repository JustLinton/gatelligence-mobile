...
class CardDetails{
  CardDetails(this.title,this.backGround,this.par);
...
class HomeFeaturedCard extends StatelessWidget {
  ...
  CardDetails getCardDetails(){
   ...
   if (type == 3) {
    ...
    return CardDetails('这里是讲堂', 'https://linton-pics.oss-cn-beijing.aliyuncs.com/uPic/test1.jpg', 'type');
  }
